...
> **Note:** If your custom domain uses your own TLS certificate and you want to migrate to an Okta-managed certificate, contact your Okta account team or open a support case to request a seamless migration with no downtime.
