...
2. Create a new CNAME record and paste the value from the **Host** column in the **Create/modify a DNS CNAME record** section into the appropriate field at the registrar, for example, the **Name** or **Host** field.
...
3. Paste the value from the **Data** column that you copied in the **Create a DNS CNAME record** section into the appropriate field at the registrar, for example, the **Record** or **Value** field.
4. Save the record.
